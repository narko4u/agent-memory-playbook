...
description: How Empire Labs Pty Ltd gave a 12-agent autonomous fleet durable memory across sessions - hot memory, state files, session search, and the verify-before-assert discipline.
tags: ["ai", "devops", "opensource", "python"]
cover_image: https://raw.githubusercontent.com/narko4u/agent-memory-playbook/main/og-cover.png
published: false
---
...
*Building open infrastructure for autonomous AI agents. MIT-licensed. [agent-memory-playbook on GitHub](https://github.com/narko4u/agent-memory-playbook).*
